...
function Instruction() {
  return (
    <div className="instruction">
        <div className="frame">
            <p className="frameText">UI/UX 	&#62; Refer & Earn </p>
        </div>
        <div className="dashboard">
            <div className="withdrawContainer">
                <div className="withdrawTop">
                    <div className="withdrawTopItem earning">
                        <p className="earningTitle">Referral Earning</p>
                        <h4 className="earningAmount">$ 2,500</h4>
                    </div>
                    <div className="withdrawTopItem totalReferrals">
                        <p className="totalReferralsTitle">Total Referrals</p>
                        <h4 className="totalReferralsNum">7</h4>
                    </div>
                    <div className="withdrawTopItem wBalance">
                        <p className="wBalanceTitle">Wallet Balance</p>
                        <h4 className="wBalanceAmount">$ 500</h4>
                    </div>
                </div>
                <div className="withdrawBtn"><p>Withdraw Balance</p></div>
            </div>
            <div className="yourReferralCode">
                <p className="yourReferralCodeTitle">Your Referral Code</p>
            ...
            <div className="workingSteps">
                <div className="step">
                    ...
                    <div className="stepContent">
                        <h4 className="stepHeading">Invite your Friends</h4>
                        <p className="stepText">Share the link tutedude.com with your friends</p>
                    </div>
                </div>               
                <div className="step">
                    <div className="stepLogo">
                    ...
                    <div className="stepContent">
                        <h4 className="stepHeading">You get ₹ 200 as referral money</h4>
                        <p className="stepText">On total purchase the friend makes into your wallet</p>
                    </div>
                </div>               
                <div className="step">
                    <div className="stepLogo">
                    ...
                    <div className="stepContent">
                        <h4 className="stepHeading">Transfer money from wallet</h4>
                        <p className="stepText">When the wallet balance reaches ₹200 or more, you can withdraw it</p>
                    </div>
                </div>               
                <div className="step">
                    <div className="stepLogo">
                    ...
                    <div className="stepContent">
                        <h4 className="stepHeading">Friend purchases any course</h4>
                        <p className="stepText">Using your REFERRAL CODE in the payments page</p>
                    </div>
                </div>               
                <div className="step">
                    <div className="stepLogo">
                    ...
                    <div className="stepContent">
                        <h4 className="stepHeading">Your Friend get ₹ 200 Off</h4>
                        <p className="stepText">On his overall fee on successful purchase using your rererral code</p>
                    </div>
                </div>               
            </div>
        </div>
        <Link className="link" to="/friends" >
            <p className="bottomTextLinks friendsWhoEnrolled">
                Friends Who Enrolled
            </p>
        </Link>
        <p className="bottomTextLinks TermsAndCondition">Terms And conditions</p>
    </div>
  )
}
